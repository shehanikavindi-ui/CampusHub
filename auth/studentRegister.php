        ...
        <div class="auth-form-wrapper">
            ...
            <form class="auth-form" id="registerForm" novalidate>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group avatar-group">
                        ...
                        <div class="avatar-upload-area" id="avatarArea" title="Click to upload photo">
                            ...
                            <input type="file" id="avatarInput" accept="image/*" hidden aria-label="Upload profile photo">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label" for="dob">Date of Birth <span class="form-required">*</span></label>
                            <div class="input-icon-wrap">
                ...
                <div class="form-section">
                    ...
                    <!-- Student ID -->
                    <div class="form-group">
                        <label class="form-label" for="studentId">Student ID / Matric Number <span class="form-required">*</span></label>
                        <div class="input-icon-wrap">
                    ...
                    <!-- Institution -->
                    <div class="form-group">
                        <label class="form-label" for="institution">Institution <span class="form-required">*</span></label>
                        <div class="input-icon-wrap">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label" for="faculty">Faculty / Department <span class="form-required">*</span></label>
                            <div class="input-icon-wrap">
                                <i class="bi bi-building-columns input-icon"></i>
                                <select class="form-control form-select" id="faculty" name="faculty" required>
                                    ...
                                    for ($i=0; $i < $faculty_num; $i++) { 
                                        ...
                                        ?>
                                        <option value="<?php echo $faculty_data['id']; ?>"><?php echo $faculty_data['name']; ?></option>
                                        <?php
                                        }
                                    ?>
                                </select>
                        ...
                        <div class="form-group">
                            <label class="form-label" for="programme">Programme / Course <span class="form-required">*</span></label>
                            <div class="input-icon-wrap">
                                <i class="bi bi-building-columns input-icon"></i>
                    ...
                    <div class="form-group form-group--half">
                        <label class="form-label" for="yearOfStudy">Year of Study <span class="form-required">*</span></label>
                        <div class="input-icon-wrap">
                            ...
                            <select class="form-control form-select" id="yearOfStudy" name="yearOfStudy" required>
                                ...
                                for ($y=0; $y < $yos_num; $y++) { 
                                    ...
                                    ?>
                                    <option value="<?php echo $yos_data['id']; ?>"><?php echo $yos_data['name']; ?></option>
                                    <?php
                                    }
                                ?>
                            </select>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <ul class="pw-rules">
                            <li class="pw-rule" id="rule-len"><i class="bi bi-check-circle"></i> At least 8 characters</li>
                            <li class="pw-rule" id="rule-up"><i class="bi bi-check-circle"></i> One uppercase letter</li>
                            <li class="pw-rule" id="rule-num"><i class="bi bi-check-circle"></i> One number</li>
                            <li class="pw-rule" id="rule-sym"><i class="bi bi-check-circle"></i> One special character</li>
                        </ul>
                    </div>

                    <!-- Confirm Password -->
                    <div class="form-group">
                        <label class="form-label" for="confirmPassword">Confirm Password <span class="form-required">*</span></label>
                        <div class="input-pw-wrap">
                            <div class="input-icon-wrap">
                            ...
                            <button type="button" class="pw-toggle" data-target="confirmPassword" aria-label="Show/hide confirm password">
                                <i class="bi bi-eye"></i>
                            </button>
                        </div>
